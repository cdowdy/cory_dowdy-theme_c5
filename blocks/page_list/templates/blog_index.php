 ...
 foreach ($pages as $page):
	...
	<?php  if ($showRss): ?>
		...
		<div class="small-12 columns">
			<a href="<?php  echo $rssUrl ?>" target="_blank"><img class="rss-icon" src="<?php  echo $rssIconSrc ?>" width="14" height="14" alt="<?php  echo t('RSS Icon') ?>" title="<?php  echo t('RSS Feed') ?>" /></a>
			</div>
		</div>
